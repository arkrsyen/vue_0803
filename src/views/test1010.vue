...
<div id="app">
  ...
  <div class="game_panel">
    ...
    <div v-if="beforePick" class="display">
      <el-button class="pickup" @click="handlePickupDisplay(1)">召喚 1 回</el-button>
      <el-button class="pickup" @click="handlePickupDisplay(10)">召喚 10 回</el-button>
    </div>
    <div v-if="pickStart" class="pickupBlock">
      <div class="display" data-row-count="5">
        <div class="data_row card_obj">
          <span class="card"><p>cards</p></span>
        </div>
      </div>
      <div class="btn_outer">
